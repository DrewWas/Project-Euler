...
# I don't see why there would be any difference in left/right
# and up/down, so if we check a subset for up then we have also
# checked that subset for down

# So we just need to check horizontally, vertically, and
# diagonaly
...
def f():
    ...
    # clean it into linked list 
    int_nums = [int(n) for n in num.split()]
    grid = [int_nums[i * 20 : (i * 20) + 20] for i in range(20)]


    from math import prod 


    # Returns max of left/right
